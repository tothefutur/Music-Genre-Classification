...
if __name__ == '__main__':
    ...
    net = classifier.classifier(conv_arch = ((1,64),(1,128),(2,256)),ratio=4,size_x=16,size_y=16,in_channels=1,layers=3)
    net.apply(classifier.weight_init)
    
    #data = GTZANDataset2.GTZANDataset(rootDir=r"..//data//music//images_original",resize=(32,448))
    dataset = process_data_simple.GTZANDataset(r"..\data\music\features_3_sec.csv", resize=(16, 16)).data
